...
Installation
============
Check requirements:  PHP 5 with cURL support enabled.  Drupal 8.x.
...
specifically for Drupal 7.x and 6.x (and Drupal 5.x too, if you still need
...
Limitations
===========
    [ Note for the Drupal 8.x version - I haven't verified that this
      information is still true for the D8 release. ]
